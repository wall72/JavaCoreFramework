				...
				<div class="span3 bs-docs-sidebar">
					<ul class="nav nav-list bs-docs-sidenav">
						...
						<ul>
							...
							<li><a href="#p21_2">파일시스템 기반에 파일과 데이터를 별도로 보내는 경우</a></li>
						</ul>
					</ul>
				</div>
				...
				<!-- Request Mapping -->
					<section id="p21">
						<div  class="page-header">
							<h3>파일 업/다운로드</h3>
							<p>
								JCF-UPLOAD 는 파일 업/다운로드 기능과 업무를 분리하여, 간단한 설정과 구현을 통하여 파일 업로드와 다운로드 기능을 제공한다.<br/>
								URL 패턴별로 다양한 요청을 처리해서 저장하는 operation을 정의해서 사용할 수 있다.
								관련 코드는com.jcf.sample.file 패키지 및 applicationContext-file.xml 에 자세히 나와있다.<br/><br/>
								<font color="RED">업/다운로드 테스트는 소스를 받은뒤 Local 에서 확인할 수 있다.</font>
							</p>
...
&lt;bean id="webFlowFileOperator" class="jcf.sua.ux.webflow.mvc.file.WebFlowFileOperator"&gt;
	&lt;property name="receivers"&gt;
		&lt;map&gt;
			&lt;entry key="/**/*FileUpload*" value-ref="uploadToFile"/&gt;
		&lt;/map&gt;
	&lt;/property&gt;
	...
	&lt;property name="senders"&gt;
		&lt;map&gt;
			&lt;entry key="/**/*FileDownload*" value-ref="downloadByFile"/&gt;
		&lt;/map&gt;
	&lt;/property&gt;
