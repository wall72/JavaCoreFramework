				...
				<div class="span9">
					...
					<section id="p31">
						<div class="page-header">
							<h3>대용량 데이터 조회</h3>
							<p>
								JCF 의 대용량 조회는 대량의 데이터를 한번에 보내는 것이 아니라 스트리밍 방식을 사용하여 DB 조회 시 한건씩 패치/가공한 후 클라이언트로 전송하여 WAS와 DB 서버의 부담을 완화한다.<br/>
								조회된 데이터는 원하는 형태 (JSON, XML 등)로 가공하여 클라이언트로 전송한다.<br/><br/>
								관련 코드는 com.jcf.sample.stream 패키지에 자세히 나와있다.
							</p>
							<pre class="prettyprint linenums">

&lt;context:component-scan base-package="jcf.sua.support.rad.service" use-default-filters="false"&gt;
...
&lt;bean id="radDao" class="jcf.sua.support.rad.dao.RadSupportDaoIbatis"&gt;
	&lt;property name="sqlMapClientTemplate" ref="sqlMapClientTemplete" /&gt;
&lt;/bean&gt;
							</pre>
						</div>
						<section id="p31_1">
