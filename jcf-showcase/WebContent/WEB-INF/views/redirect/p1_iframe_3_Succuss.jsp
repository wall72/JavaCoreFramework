...
<html>
	...
	<body>
		<div id="p11_5_result" class="bs-docs-example-result">
			<p>
페이지가 성공적으로 이동되었습니다.</br>
본 페이지는 src > META-INF > spring> jcf-context.xml 에서 설정한 webflow-prefix 의 경로인 /WEB-INF/views/ 하위의 파일 중에
 response.setViewName 아규먼트인 "/redirect/p1_iframe_3_Succuss".jsp" 파일을 호출합니다.
			</p>
		</div>
		<a href="/jcf-showcase/openpage.do?viewname=p1_iframe_3" class="btn btn-link">이전 페이지로</a>
	</body>
</html>