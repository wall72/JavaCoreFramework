...
public class CommandLineProcess implements ExternalProcess {
	...
	public String toString() {
		return "CommandLineProcess [name=" + name + ", description="
				+ description + ", commandLines="
				+ Arrays.toString(commandLines) + ", workDirectory="
				+ workDirectory + ", envMap=" + envMap + ", user=" + user
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CommandLineProcess other = (CommandLineProcess) obj;
	...
	public CommandLineProcess(String name) {
		this.name = name;
	}
