...
public class RestPermissionControllerTest {
	...
	public void 리소스세부접근권한조회() {
		MockHttpServletRequest request = new MockHttpServletRequest(HttpMethod.GET.name(), "/jcfiam/admin/permissions/");
...
//	@Ignore
	public void 리소스세부접근권한조회추가삭제() throws Exception {
		 ...
		 * 추가
		 */
		MockHttpServletRequest request = new MockHttpServletRequest(HttpMethod.POST.name(), "/jcfiam/admin/permissions/");
		MockHttpServletResponse response = new MockHttpServletResponse();
		 ...
		 * 조회
		 */
		request = new MockHttpServletRequest(HttpMethod.GET.name(), "/jcfiam/admin/permissions/");
		 ...
		 * 수정
		 */
		request = new MockHttpServletRequest(HttpMethod.PUT.name(), "/jcfiam/admin/permissions/");
		response = new MockHttpServletResponse();
		 ...
		 * 삭제
		 */
		request = new MockHttpServletRequest(HttpMethod.DELETE.name(), "/jcfiam/admin/permissions/T");
		response = new MockHttpServletResponse();
