...
public class RestAuthorityControllerTest {
	...
	public void 사용자권한리스트조회() throws Exception {
		MockHttpServletRequest request = new MockHttpServletRequest(HttpMethod.GET.name(), "/jcfiam/admin/authorities/nolang");
	...
	public void 사용자권한추가삭제조회() throws Exception {
		 ...
		 * 추가
		 */
		MockHttpServletRequest request = new MockHttpServletRequest(HttpMethod.POST.name(), "/jcfiam/admin/authorities/");
		MockHttpServletResponse response = new MockHttpServletResponse();
		 ...
		 * 조회
		 */
		request = new MockHttpServletRequest(HttpMethod.GET.name(), "/jcfiam/admin/authorities/testuser");
		 ...
		 * 삭제
		 */
		request = new MockHttpServletRequest(HttpMethod.DELETE.name(), "/jcfiam/admin/authorities/testuser");
		response = new MockHttpServletResponse();
