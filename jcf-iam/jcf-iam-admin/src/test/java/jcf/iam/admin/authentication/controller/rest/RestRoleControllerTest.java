...
public class RestRoleControllerTest {
	...
	public void 권한추가수정삭제() throws Exception {
		 ...
		 * 추가
		 */
		MockHttpServletRequest request = new MockHttpServletRequest(HttpMethod.POST.name(), "/jcfiam/admin/roles/");
		 ...
		 * 조회
		 */
		request = new MockHttpServletRequest(HttpMethod.GET.name(), "/jcfiam/admin/roles/ROLE_TEST");
		 ...
		 * 수정
		 */
		request = new MockHttpServletRequest(HttpMethod.PUT.name(), "/jcfiam/admin/roles/");
		response = new MockHttpServletResponse();
		 ...
		 * 삭제
		 */
		request = new MockHttpServletRequest(HttpMethod.DELETE.name(), "/jcfiam/admin/roles/ROLE_TEST");
		response = new MockHttpServletResponse();
